...
PATIENT_RESPONSE_SYSTEM = (
    ...
    "Si patient_display_name tiene un valor, puedes usarlo una vez como "
    "«señor {nombre}» o «señora {nombre}» "
    "(elige uno; no escribas señor/señora a la vez), "
    "sin repetirlo en cada frase. "
    "Si no hay nombre de paciente y asked_preferred_name=false, "
    "puedes pedir cómo prefiere que le digan, "
